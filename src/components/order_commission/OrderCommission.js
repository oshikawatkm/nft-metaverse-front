...
import { commissionOrderRequest } from '../../actions/orders';

const OrderCommission = ({ commissionOrderRequest, order: { order } })  => {
  useEffect(() => {
    commissionOrderRequest();
  }, [commissionOrderRequest])
...
export default connect(mapStateToProps, { commissionOrderRequest })(OrderCommission);