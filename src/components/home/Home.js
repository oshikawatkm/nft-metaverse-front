...
const Home = () => {
  return (
    <div className="main-nav row mb-4">
        ...
        <div className="col-md-5 pb-2">
          <Link to="/register_model_converter" className="program-card card bg-primary text-white text-center">
            <div className="card-body">
              <i className="fas fa-money-bill-wave fa-3x m-3" />
              <h4>Sign Up As Model Converter</h4>
              <p className="clist-link">3Dモデル変換者として登録</p>
            </div>
          </Link>
        </div>
        <div className="col-md-1"></div>
        ...
        <div className="col-md-5 pb-2">
          <Link to="/login_model_converter" className="program-card card border-primary text-center">
            <div className="card-body">
              ...
              <p className="card-content text-muted">3Dモデル変換者としてログイン</p>
            </div>
          </Link>
        </div>
        <div className="col-md-1"></div>
