...
import { postModelConverterRequest } from '../../actions/model_converters';


class RegisterModelConverter extends Component {
  constructor() {
    super();
    this.state = {
      name: '',
...
RegisterModelConverter.propTypes = {
  postModelConverterRequest: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { postModelConverterRequest })(withRouter(RegisterModelConverter));